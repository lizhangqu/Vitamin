...
public class XmlConfigTest {
    ...
    private static final Logger logger = Logger.getLogger(XmlConfigTest.class);
    ...
    public void testGet() throws IOException {
        InputStream resourceAsStream = this.getClass().getResourceAsStream("/testData/test.xml");
        ReadableConfig readableConfig = Vitamin.getInstance().getReadableConfig(ConfigType.XML, resourceAsStream);
        ...
        Assert.assertEquals(123, anInt);
        Assert.assertEquals(1234.12345, aFloat, 1);
        Assert.assertEquals(1334563.23424, aDouble, 1);
        Assert.assertEquals(123412, aLong);
        Assert.assertEquals("just a test", string);
