...
public class YamlConfigTest {
    ...
    private static final Logger logger = Logger.getLogger(YamlConfigTest.class);
    ...
    public void testGet() {
        InputStream resourceAsStream = this.getClass().getResourceAsStream("/testData/test.yaml");
        ReadableConfig readableConfig = Vitamin.getInstance().getReadableConfig(ConfigType.YAML, resourceAsStream);
        ...
        Assert.assertEquals(1234.3, aFloat, 1);
        Assert.assertEquals(132324.23, aDouble, 1);
        Assert.assertEquals(12345, aLong);
        Assert.assertEquals("12345tgvcxzsf", string);
